...
// Your code here
console.log("String One = " + stringOne + ", " + "Number of characters = " + lengthOne);
console.log("String Two = " + stringTwo + ", " + "Number of characters = " + lengthTwo);
console.log("String Three = " + stringThree + ", " + "Number of characters = " + lengthThree);
